...
export default () => {
    ...
    query {
        pattern:file(relativeDirectory: {}, relativePath: {eq: "pattern.jpg"}, childImageSharp: {fluid: {sizes: {}}}) {
            childImageSharp {
